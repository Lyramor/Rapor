                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end"">
                                        <a href="{{ route('sisipan.periode.create') }}" class="btn btn-primary"
                                            ...
                                            @else
                                                @foreach ($data as $periodeRemedial)
                                                    <tr style="text-align: center;vertical-align: middle;">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('sisipan.periode.edit', ['id' => $periodeRemedial->id]) }}"
                                                                class="btn btn-sm btn-warning edit">
                                                                <i class="fas fa-edit fa-xs"></i>
                                                            </a>
                                                            <a href="{{ route('sisipan.periode.prodi', ['id' => $periodeRemedial->id]) }}"
    ...
    <div class="modal fade" id="modalSalin" tabindex="-1" aria-labelledby="modalSalinLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSalinSoal" action="{{ route('sisipan.periode.salin') }}" method="POST">
                    @csrf
