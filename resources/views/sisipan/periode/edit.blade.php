        ...
        <div class="row justify-content-md-center">
            <div class="col-10">
                <div class="judul-modul">
                    <span>
                        <h3>Periode Sisipan</h3>
                        <p>Edit Periode Sisipan</p>
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-md-center">
                <div class="col-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('sisipan.periode.update', $data->id) }}" method="POST" id="form-soal">
                                @csrf
                                @method('PUT')
                                <div class="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-select" name="kode_periode" id="kode_periode" required>
                                                {{-- <option value="">Pilih Periode Sisipan</option> --}}
