                                        ...
                                        @if ($data->count() > 0)
                                            @foreach ($data as $kelas)
                                                <tr style="text-align: center;vertical-align: middle;">
                                                    ...
                                                    <td>{{ $kelas->sisipanKelas->kodemk }}</td>
                                                    <td>{{ $kelas->sisipanKelas->kelaskuliah->namamk }}</td>
                                                    <td>{{ $kelas->sisipanKelas->dosen->nama }}</td>
                                                    <td>{{ $kelas->sisipanKelas->kode_edlink }}</td>
                                                    <td>{{ $kelas->sisipanKelas->catatan }}</td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
